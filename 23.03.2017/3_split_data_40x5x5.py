...
for motion_cnt in range(1, 51):
    ...
    if motion_cnt == 2 or motion_cnt == 12 or motion_cnt == 22 or motion_cnt == 32 or motion_cnt == 42:
        ...
        for i in range(1, fcount(srcPath + 'motion' + str(motion_cnt) + '/imgs1/') + 1):
        ...
        for i in range(1, fcount(srcPath + 'motion' + str(motion_cnt) + '/imgs2/') + 1):
        ...
        for i in range(1, fcount(srcPath + 'motion' + str(motion_cnt) + '/imgs3/') + 1):
