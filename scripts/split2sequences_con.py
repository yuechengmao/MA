...
dstPath = '/Users/' + hostname + '/Desktop/tensorflow/sequences_con/'
    ...
    while i < fcount(srcPath + 'motion' + str(motion_cnt) + '/imgs1/'):
        ...
        if cnt == seq_length:
            if motion_cnt == 8 or motion_cnt == 18 or motion_cnt == 28 or motion_cnt == 38 or motion_cnt == 48:
                ...
                np.savetxt(testPath + 'seq_label' + str(test_cnt) + '.csv', data[i - seq_length + 1:i + 1,:], fmt='%.8f', delimiter=',')
                ...
                np.savetxt(trainPath + 'seq_label' + str(seq_cnt) + '.csv', data[i - seq_length + 1:i + 1,:], fmt='%.8f', delimiter=',')
